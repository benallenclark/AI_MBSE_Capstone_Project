...
from app.interface.api.v1.analyze import router as analyze_router
from app.interface.api.v1.get_model import router as models_public_router
from app.interface.api.v1.health import router as health_router
from app.interface.api.v1.jobs import router as jobs_router
from app.interface.api.v1.rag import router as rag_router
from app.interface.api.v1.rag_stream import router as rag_stream_router
