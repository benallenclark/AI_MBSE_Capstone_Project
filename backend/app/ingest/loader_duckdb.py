...
from app.utils.timing import log_timer as _timer
...
# NOTE: identifier quoting is handled inside app.ingest.parquet_views
...
# ---- CLI for `python -m app.ingest.loader_duckdb` ----
def _main():
